...
INSERT INTO `alumnos_por_clase` (`id`, `id_clase`, `id_alumno`, `fecha_hora`) VALUES
	(7, 1, 2, '2017-11-21 21:51:55'),
	(8, 1, 4, '2017-11-21 21:51:55');
...
-- Dumping data for table institucion_educativa.usuario: ~0 rows (approximately)
/*!40000 ALTER TABLE `usuario` DISABLE KEYS */;
INSERT INTO `usuario` (`id`, `username`, `password`, `id_persona`) VALUES
	(1, 'admin', 'fe01ce2a7fbac8fafaed7c982a04e229', NULL),
	(2, 'padre', 'fe01ce2a7fbac8fafaed7c982a04e229', 6);
